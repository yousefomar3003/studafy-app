...
-- These tests intentionally prove both sides of the security boundary. The
-- test seed must define :student_user, :guardian_user, :unverified_guardian,
-- :teacher_user, :other_school_user and :student_id before this file runs.
