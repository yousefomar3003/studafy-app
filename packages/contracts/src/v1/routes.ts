...
export const V1_ROUTE_CATALOGUE = [
  ...
  academicPost(
    ...
    Billing.V1RequestPurchaseApprovalRequest,
    "V1RequestPurchaseApprovalRequest",
    Billing.V1PurchaseApproval,
    "V1PurchaseApproval",
    201,
  ),
  academicGet(
  ...
  // DL-049. Appended so no existing module's catalogue slice shifts.
  academicGet(
    "listContacts",
    "/v1/contacts",
    "contact.list",
    Communications.V1ContactPage,
    "V1ContactPage",
    undefined,
    Academic.V1PageQuery,
  ),
  // DL-050. A guardian's own links and the children they concern.
  academicGet(
    "listMyGuardianLinks",
    "/v1/me/guardian-links",
    "guardian_link.list_own",
    Family.V1MyGuardianLinksResponse,
    "V1MyGuardianLinksResponse",
  ),
  // DL-051. The caller's own finished data export.
  academicGet(
    "downloadDataExport",
    "/v1/account/export-download",
    "account.export.download",
    Account.V1DataExportDocument,
    "V1DataExportDocument",
  ),
  // DL-053. Push registration for the signed-in person's device.
  academicPost(
    "registerPushDevice",
    "/v1/me/push-devices",
    "push_device.manage",
    Notifications.V1RegisterPushDeviceRequest,
    "V1RegisterPushDeviceRequest",
  ...
  academicPost(
    ...
    "/v1/me/push-devices/unregister",
    "push_device.manage",
    Notifications.V1UnregisterPushDeviceRequest,
    "V1UnregisterPushDeviceRequest",
    Notifications.V1PushDeviceResponse,
    "V1PushDeviceResponse",
    200,
  ),
